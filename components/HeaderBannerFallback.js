...
export default function HeaderBannerFallback() {
  ...
  return (
    <header className="header-banner">
      ...
      <div className="banner-background">
        ...
        <div className={`overlay-gradient ${imageError ? 'fallback-gradient' : ''}`}></div>
      </div>
      ...
      <style jsx>{`
        ...
        @keyframes floatBubble {
          ...
          50% {
            transform: translateY(0px) translateX(40px) rotate(10deg);
          }
          75% {
            transform: translateY(30px) translateX(20px) rotate(5deg);
          }
